...
docker exec -it broker /bin/kafka-topics --delete --if-exists --topic resultQuery1-1hour --bootstrap-server localhost:9092
...
docker exec -it broker /bin/kafka-topics --create --topic resultQuery1-1hour --bootstrap-server localhost:9092
