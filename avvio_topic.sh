...
docker exec -it broker /bin/kafka-topics --delete --topic resultQuery2-30minutes --bootstrap-server localhost:9092
docker exec -it broker /bin/kafka-topics --delete --topic resultQuery2-1hour --bootstrap-server localhost:9092
docker exec -it broker /bin/kafka-topics --delete --topic resultQuery2-1day --bootstrap-server localhost:9092
docker exec -it broker /bin/kafka-topics --delete --topic resultQuery3-30minutes --bootstrap-server localhost:9092
docker exec -it broker /bin/kafka-topics --delete --topic resultQuery3-1hour --bootstrap-server localhost:9092
docker exec -it broker /bin/kafka-topics --delete --topic resultQuery3-1day --bootstrap-server localhost:9092
echo "Creo i topic"
